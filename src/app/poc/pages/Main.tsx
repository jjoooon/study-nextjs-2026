...
import type { CustomerSearchDialogResult } from '@/features/poc/components/CustomerSearchDialog';
...
export default function MainPage() {
  ...
  // 컴포넌트 마운트 시 팝업 등록
  useEffect(() => {
    registerDialog('products/customer-search', () => import('@/features/poc/components/CustomerSearchDialog'));
  }, []);
