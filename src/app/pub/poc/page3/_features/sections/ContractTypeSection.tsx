...
import { SELECT_OPTIONS, RADIO_OPTIONS } from '../constants/main';
import type { TabData } from '../types/main';
...
export function ContractTypeSection({ active, currentData, testError, handleChange }: ContractTypeSectionProps) {
  return (
