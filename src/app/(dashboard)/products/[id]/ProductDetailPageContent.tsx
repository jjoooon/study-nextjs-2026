...
/**
 * Product Detail Page 컨텐츠 컴포넌트
 *
 * Dynamic Reducer Pattern으로 products reducer를 주입
 */
export function ProductDetailPageContent({ id }: ProductDetailPageContentProps) {
  ...
  // 2️⃣ 준비되면 실제 컨텐츠 렌더링
  return <ProductDetailPageContentInner id={id} />;
}

// ============================================================================
// PRODUCT DETAIL PAGE CONTENT INNER
// ============================================================================
 ...
 */
function ProductDetailPageContentInner({ id }: { id: string }) {
