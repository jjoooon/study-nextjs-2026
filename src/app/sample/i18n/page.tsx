...
import {
  ...
  SelectTrigger,
  SelectValue,
} from '@/shared/components/uiux/Select';
      ...
      <div className="grid gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              다양한 언어 선택 방식을 시도해보세요 (messageUtils 기반)
            </CardDescription>
          </CardHeader>
          ...
          <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  messageUtils를 사용한 간단한 메시지 조회
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h4 className="font-semibold mb-2">getMessage() 사용법</h4>
                  <pre className="text-sm bg-white p-2 rounded border mb-2">
                    {`getMessage('header.title')`}
                  </pre>
                  <p className="text-sm">결과: <span className="font-medium">{getMessage('header.title')}</span></p>
                </div>
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm">결과: <span className="font-medium">{msg('header.home')}</span></p>
                </div>
                ...
                <div className="bg-yellow-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm">결과: <span className="font-medium">{msg('header.dashboard', 'en')}</span></p>
                </div>
              </CardContent>
            </Card>
