            ...
            <div className="flex justify-center pt-1 relative items-center">
                ...
                <div className="space-x-1 flex items-center">
                    <Button
                        ...
                        variant={"outlined"}
                        className="inline-flex items-center justify-center h-7 w-7 p-0 absolute left-1"
                    >
                    ...
                    <Button
                        ...
                        variant={"outlined"}
                        className="inline-flex items-center justify-center h-7 w-7 p-0 absolute right-1"
                    >
