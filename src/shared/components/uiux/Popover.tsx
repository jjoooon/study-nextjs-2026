...
>((props, ref) => {
  ...
  return (
    <PopoverPrimitive.Portal {...(portalContainer ? { container: portalContainer } : {})}>
      ...
      >
        {closeButton && (
          <PopoverPrimitive.Close aria-label="Close" className="absolute -top-2 -right-2 p-1 rounded hover:bg-[var(--color-gray-90)] focus:outline-none w-[1.8rem] h-[1.8rem] flex items-center justify-center bg-[var(--color-gray-70)] rounded-full">
