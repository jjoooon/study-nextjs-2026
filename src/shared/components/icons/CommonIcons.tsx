...
export const InputClearIcon: React.FC<IconProps> = ({ className = '', size = 14, color = 'var(--color-gray-30)' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={toRem(size)}
    height={toRem(size)}
...
export const NewPopupIcon: React.FC<IconProps> = ({ className = '', size = 14, color = '#61554F' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={toRem(size)}
    height={toRem(size)}
