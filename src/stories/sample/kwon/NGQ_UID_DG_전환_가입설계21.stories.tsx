...
const meta: Meta = {
  title: 'Sample/kwon/NGQ_UID_DG_V0.22/21_급배수스프링부호선택',
  tags: ['autodocs'],
  parameters: {
    layout: 'padded',
    docs: {
    ...
    <Gcol>
        ...
        <FormTable variant={'none'} caption="설계번호" cols={['w-[14rem] min-w-[14rem]']}>
          ...
          <FormRow>
            <FormCell title={'준공연도(사용승인연도)'}>
              <Input size="lg" variant="default" width="18rem" onChange={(e) => setFormField('type01', e.target.value)} value={form.type01} />
            </FormCell>  
          </FormRow>
        </FormTable>
      </Grow>
      ...
      <Grow className='w-full'>
        <FormTable caption="담보" cols={['w-[14rem] min-w-[14rem]', 'w-auto']}>
          <FormRow>
            <FormCell title={'담보명'}>
              <Input size="lg" variant="default" width="18rem" onChange={(e) => setFormField('type02', e.target.value)} value={form.type02}  readOnly/>
            </FormCell>
            <FormCell title={'담보명'}>
              <Input size="lg" variant="default" width="18rem" after="만원"onChange={(e) => setFormField('type03', e.target.value)} value={form.type03} commaAmount readOnly/>
            </FormCell>
          </FormRow>
        </FormTable>
      </Grow>
