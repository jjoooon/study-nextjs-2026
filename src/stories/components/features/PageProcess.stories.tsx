        ...
        <>
          ...
          <div>
            <p>
              ...
              <br />
              현재 활성화된 단계와 완료된 단계를 시각적으로 구분하여 사용자가 진행 상태를 쉽게 파악할 수 있도록
              돕습니다.
            </p>
          </div>
...
\`\`\`
          ...
          <h2>API Reference</h2>
          <p>
            필수 props는 <strong>items</strong>이며, 완료 단계는 <strong>completeSteps</strong>, 현재 단계는{' '}
            <strong>activeStep</strong> 또는 <strong>defaultActiveStep</strong>으로 제어합니다.
          </p>
        </>
      ),
    },
