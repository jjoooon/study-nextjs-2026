...
const Ltpz001 = () => {
  ...
  return (
    <>
      ...
      <ConfirmDialog
        open={confirmDialog1Open}
        onOpenChange={setConfirmDialog1Open}
        description={
          <Gcol placement="ss" gap={3}>
            <Typo variant={'body-md'}>
              청약서, 상품설명서, 비교안내확인서, 고객확인서(자금세탁방지)
              <br />
              출력 이력이 저장되지 않았습니다.
            </Typo>
            <Typo variant={'body-md'}>
              <b>출력이력이 없는 경우 스캔이 불가</b>하니 <b className="text-[var(--color-primary-50)]">재발행 후</b>
              <br /> 진행하실 바립니다.
            </Typo>
          </Gcol>
        }
      ...
      <ConfirmDialog
        open={confirmDialog2Open}
        onOpenChange={setConfirmDialog2Open}
        description={
          <Gcol placement="ss" gap={3}>
            <Typo variant={'body-lg'}>
              <b>{'모바일'}</b> <b className="text-[var(--color-primary-50)]">{'3'}건</b>의 전송 요청이 접수되었습니다.
            </Typo>

            <Gcol placement="ss" gap={1}>
              <Grow placement="ec" className="w-full">
                <Typo variant={'body-sm'} color={'primary'}>
                  전송 성공: {'3'}
                </Typo>
              </Grow>
              <Table>
                <TableBody>
                  <TableRow>
                    <TableHead>받는번호</TableHead>
                    <TableCell> {'010-0000-0000'}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableHead>설계번호</TableHead>
      ...
      <ConfirmDialog
        open={confirmDialog3Open}
        onOpenChange={setConfirmDialog3Open}
        description={
          <Gcol placement="ss" gap={3}>
            <Typo variant={'body-lg'}>
              <b>{'팩스'}</b> <b className="text-[var(--color-primary-50)]">{'3'}건</b>의 전송 요청이 접수되었습니다.
              <br />
              실제 전송 처리시간은 수신측 상태에 따라 달라질 수 있습니다.
            </Typo>
      ...
      />
      <ConfirmDialog
        open={confirmDialog4Open}
        onOpenChange={setConfirmDialog4Open}
        description={
          <Gcol placement="ss" gap={3}>
            <Typo variant={'body-lg'}>
              <b>{'이메일'}</b> <b className="text-[var(--color-primary-50)]">{'3'}건</b>의 전송 요청이 접수되었습니다.
              <br />
              실제 전송 처리시간은 수신측 상태에 따라 달라질 수 있습니다.
            </Typo>
