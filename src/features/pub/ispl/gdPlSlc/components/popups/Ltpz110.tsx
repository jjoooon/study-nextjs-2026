  ...
  if (isPopover) {
    return (
      <PopoverContent
        ...
        className="w-[48rem] p-5 shadow-xl bg-white border border-[var(--color-gray-20)] rounded-[0.8rem] z-200"
      >
        <Gcol className="w-full" gap="4">
          <div className="w-full flex items-center justify-between border-b border-[var(--color-gray-10)] pb-3">
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent showCloseButton resizable={true} size="md">
        ...
        <DialogSection>{renderBody()}</DialogSection>
