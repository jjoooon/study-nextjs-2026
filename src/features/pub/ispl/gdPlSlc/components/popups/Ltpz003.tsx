...
import { QuestionRadioCard, QuestionRadioCardHeader, QuestionRadioCardHeaderTitle, QuestionRadioCardContents } from '@/shared/components/common/QuestionRadioCard';
            ...
            <QuestionRadioCard isRadio={true} isValue="Y" disabled>
              ...
              <QuestionRadioCardContents>
                <Grid className="w-full grid-cols-4 gap-[0.8rem] px-[1rem]">
                  <Checkbox color="primary" errorMsg="선택은 필수입니다." errorPs="bl" onCheckedChange={() => {}} size="lg" variant="default" disabled>
                    질병확정진단
                  </Checkbox>
                  <Checkbox color="primary" errorMsg="선택은 필수입니다." errorPs="bl" onCheckedChange={() => {}} size="lg" variant="default" disabled>
                    질병의심소견
