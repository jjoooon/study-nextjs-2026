...
export const Ltpa35001 = ({
  ...
  return (
    <>
                  ...
                  <Gcol placement={'ss'} className="w-full overflow-x-hidden" gap={3}>
                    ...
                    <FormTable cols={['w-[12rem]', 'w-[40%]', 'w-[12rem]', 'w-[auto]']}>
                      ...
                      <FormRow>
                        ...
                        <FormCell title={'보험기간'}>
                          <Input placeholder="____-__-__" width={84} readOnly />-
                          <Input
                    ...
                    {currentTab?.type !== '연금저축' && (
                      <TabPager
                        ...
                        renderDropdownItem={(tab, setActive, setVisibleStart, data, visibleCount, active) => {
                          ...
                          const isSelected = String(tab.value) === String(active);
                          return (
                            <Button
                              variant={'none'}
      ...
      <Dialog open={isLtpa35001PopupOpen} onOpenChange={setIsLtpa35001PopupOpen}>
              ...
              <Gcol placement="ss" gap={2}>
                <BulletList position="col" className="gap-1">
                  ...
                  <BulletListItem className="flex-row font-bold text-[1.2rem]">
                    ...
                    <BulletList position="col" type="dash" className="-ml-2 font-normal">
                      <BulletListItem className="text-[1.2rem]">
                        가족관계증명서 또는 주민등록등본 내 계약자(또는 배우자)의 육아휴직(육아기 근로시간 단축)
                        확인서의 육아휴직 기간 확인
                      </BulletListItem>
                      <BulletListItem className="text-[1.2rem]">
                        계약자가 미성년자인 경우, 기본증명서의 법정대리인(친권자)와 법정대리인 등록화면에 등록된 대상과
