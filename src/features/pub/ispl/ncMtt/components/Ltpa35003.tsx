        ...
        <LayoutMain className="grid grid-rows-[1fr] h-full">
          <LayoutMainBody>
            <LayoutScrollWrap className="grid-cols-[1fr_auto] gap-3">
              <LayoutScrollItem className="w-full h-full grid-rows-[auto_1fr] scroll-smooth" data-layout="scroll-item">
                <TabPager
                ...
                <Gcol gap={2} className="mt-[1.2rem]">
                  ...
                  >
                    <QuestionRadioCardHeader>
                      <QuestionRadioCardHeaderTitle badgeLabel="1">
                        최근 3개월 이내에 의사로부터 진찰 또는 검사(건강검진 포함)를 통하여 다음과 같은 의료행위를 받은
                        사실이 있습니까?
                      </QuestionRadioCardHeaderTitle>
                      <RadioGroup
                    ...
                    <QuestionRadioCardContents>
                      <Gcol className="w-full" placement="ss" variant="box-detail">
                        <Typo icon="detail" variant="body-sm">
                          ...
                          의미하며, 병증에 대한 치료 필요 없이 유지되는 상태에서 시행하는 정기검사 또는 추적관찰은
                          포함하지 않습니다.
                        </Typo>
                      </Gcol>
                    </QuestionRadioCardContents>
                  ...
                  >
                    ...
                    <QuestionRadioCardContents>
                      ...
                      <Gcol className="w-full" placement="ss" variant="box-detail">
                        <Typo icon="detail" variant="body-sm">
                          기타에 해당하는 경우 차종을 구체적으로 기재하고, 둘 이상의 차량을 운전하거나 하나의 차량을 둘
                          이상의 목적으로 사용하는 경우 해당되는 사항을 모두 기재하십시오.
                        </Typo>
                      </Gcol>
                    </QuestionRadioCardContents>
                  </QuestionRadioCard>
                  ...
                  >
                    <QuestionRadioCardHeader>
                      <QuestionRadioCardHeaderTitle badgeLabel="8">
                        ...
                        개인형 이동장치를 포함)를 사용하십니까? (다만, 전동휠체어, 의료용 스쿠터 등 보행보조용 의자차는
                        제외합니다.)
                      </QuestionRadioCardHeaderTitle>
                      <RadioGroup
                        className={'gap-[1.2rem] w-[11rem]'}
                    ...
                    <QuestionRadioCardContents>
                      <Gcol className="w-full" placement="ss" variant="box-detail">
                        <Typo icon="detail" variant="body-sm">
                          계속적으로 사용(직업, 직무 또는 동호회 활동과 출퇴근용도 등으로 주로 사용하는 경우에 한함)하는
                          경우 기재
                        </Typo>
                        <Typo icon="detail" variant="body-sm">
