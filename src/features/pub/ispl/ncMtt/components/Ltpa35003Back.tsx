              ...
              <LayoutScrollWrap className="grid-cols-[1fr_auto] gap-3">
                  ...
                  <Gcol gap={2}>
                    <Gcol variant={'box-round'} placement={'ss'} className="w-full">
                      <Typo variant={'body-sm'} weight={'bold'}>
                        ■ 이 청 약서에서 ‘최근 3개월 1년, 5년 이내’는 청약일의 3개월, 1년, 5년 전일부터 청약일가지를
                        의미합니다. (예를 들어 청약일이 4월 1일 인 경우 ‘최근 3개월 1년, 5년 이내’는 1월 1일부터 4월
                        1일까지)
                      </Typo>
                    </Gcol>
                    ...
                    >
                      <QuestionRadioCardHeader>
                        <QuestionRadioCardHeaderTitle badgeLabel="1">
                          최근 3개월 이내에 의사로부터 진찰 또는 검사(건강검진 포함)를 통하여 다음과 같은 의료행위를
                          받은 사실이 있습니까?
                        </QuestionRadioCardHeaderTitle>
                        <RadioGroup
                        ...
                        >
                          {[
                            ...
                            <RadioGroupItem key={option.value} value={option.value} disabled={_simpleMode}>
                              {option.label}
                            </RadioGroupItem>
                          ))}
                        </RadioGroup>
                      ...
                      <QuestionRadioCardContents>
                        <Grid className="w-full grid-cols-4 gap-[0.8rem] px-[1rem]">
                          {['질병확정진단', '질병의심소견', '치료', '입원', '수술(제왕절개포함)', '투약'].map(
                            (label) => (
                              <Checkbox
                                key={label}
                                color="primary"
                        ...
                        <Gcol className="w-full" placement="ss" variant="box-detail">
                          <Typo icon="detail" variant="body-sm">
                            <b>질병의심소견</b>이란 의사가 진단서나 소견서 또는 진료의뢰서 등을 포함하여 서면(전자문서
                            포함)으로 교부한 경우를 말합니다.
                          </Typo>
                          <Typo icon="detail" variant="body-sm">
                            <b>투약이란</b> 의사가 환자에게 약을 처방하는 행위를 말하는 것으로 실제로 약을 구입하지
                            않았어도 기재해야 합니다.
                          </Typo>
                        </Gcol>
                      </QuestionRadioCardContents>
                    ...
                    >
                      <QuestionRadioCardHeader>
                        <QuestionRadioCardHeaderTitle badgeLabel="2">
                          최근 3개월 이내에 마약을 사용하거나 혈압강하제, 신경안정제, 수면제, 각성제(흥분제), 진통제 등
                          약물을 상시 복용한 사실이 있습니까?
                        </QuestionRadioCardHeaderTitle>
                        <RadioGroup
                          className={'gap-[1.2rem] w-[11rem]'}
                      ...
                      <QuestionRadioCardContents>
                        <Gcol className="w-full" placement="ss" variant="box-detail">
                          <Typo icon="detail" variant="body-sm">
                            <b>혈압강하제</b>란 혈압을 내리게 하는 의약품을 말하며, 각성제란 신경계를 흥분시켜 잠이 오는
                            것을 억제하는 의약품을 말합니다.
                          </Typo>
                        </Gcol>
                      </QuestionRadioCardContents>
                    ...
                    >
                      <QuestionRadioCardHeader>
                        <QuestionRadioCardHeaderTitle badgeLabel="3">
                          최근 1년 이내에 의사로부터 진찰 또는 검사를 받고, 이를 통하여 추가검사(재검사)를 받은 사실이
                          있습니까?
                        </QuestionRadioCardHeaderTitle>
                        <RadioGroup
                          className={'gap-[1.2rem] w-[11rem]'}
                      ...
                      <QuestionRadioCardContents>
                        <Gcol className="w-full" placement="ss" variant="box-detail">
                          <Typo icon="detail" variant="body-sm">
                            <b>추가검사(재검사)</b>란 검사 결과 이상 소견이 확인되어 보다 정확한 진단을 위해 시행한
                            검사를 의미하며, 병증에 대한 치료 필요 없이 유지되는 상태에서 시행하는 정기검사 또는
                            추적관찰은 포함하지 않습니다.
                          </Typo>
                        </Gcol>
                      </QuestionRadioCardContents>
                    ...
                    >
                      <QuestionRadioCardHeader>
                        <QuestionRadioCardHeaderTitle badgeLabel={'4'}>
                          최근 5년 이내에 의사로부터 진찰 또는 검사를 통하여 다음과 같은 의료행위를 받은 사실이
                          있습니까?
                        </QuestionRadioCardHeaderTitle>
                        <RadioGroup
                          className={'gap-[1.2rem] w-[11rem]'}
                      ...
                      <QuestionRadioCardContents>
                        <Grid className="w-full grid-cols-4 gap-[0.8rem] px-[1rem]">
                          {['입원', '수술(제왕제갤포함)', '계속하여 7일이상 치료', '계속하여 30일이상 투약'].map(
                            (label) => (
                              <Checkbox
                                key={label}
                                color="primary"
                        ...
                        <Gcol className="w-full" placement="ss" variant="box-detail">
                          <Typo icon="detail" variant="body-sm">
                            여기서 <b>‘계속하여’</b>란 같은 원인으로 치료 시작 후 완료일까지 실제 치료, 투약 받은 일수를
                            말합니다.
                          </Typo>
                        </Gcol>
                      </QuestionRadioCardContents>
                    ...
                    >
                      <QuestionRadioCardHeader>
                        <QuestionRadioCardHeaderTitle badgeLabel={'5'}>
                          최근 5년 이내에 아래의 질병으로 의사로부터 진찰 또는 검사를 통하여 다음과 같은 의료행위를 받은
                          사실이 있습니까?
                        </QuestionRadioCardHeaderTitle>
                        <RadioGroup
                          className={'gap-[1.2rem] w-[11rem]'}
                      ...
                      <QuestionRadioCardContents>
                        ...
                        <Gcol placement="ss">
                          ...
                          <Checkbox
                            ...
                            disabled={_simpleMode}
                          >
                            직장 또는 항문 관련 질환(치질, 치루(누공), 치열(찢어짐), 항문 농양(고름집), 직장 또는
                            항문탈출, 항문출혈, 항문궤양)
                          </Checkbox>
                          <FormTable
                      ...
                      <QuestionRadioCardContents>
                        ...
                        <Gcol className="w-full" placement="ss" variant="box-detail">
                          <Typo icon="detail" variant="body-sm">
                            ...
                            <b>직업*</b> 또는 <b>직무*</b>가 <b>변경*</b>된 사실(예:사무관리 ↔ 현장관리)을 지체없이
                            회사에 알리지 않은 경우 계약 해지 등 알릴 의무 위반에 따른 <b>불이익*</b>이 발생할 수
                            있습니다. <b>(*보험계약자가 직접 기재하여야 하는 문구)</b>
                          </Typo>
                        </Gcol>
                      </QuestionRadioCardContents>
                    </QuestionRadioCard>
                    ...
                    >
                      ...
                      <QuestionRadioCardContents>
                        ...
                        <Gcol className="w-full" placement="ss" variant="box-detail">
                          <Typo icon="detail" variant="body-sm">
                            기타에 해당하는 경우 차종을 구체적으로 기재하고, 둘 이상의 차량을 운전하거나 하나의 차량을
                    ...
                    >
                      <QuestionRadioCardHeader>
                        <QuestionRadioCardHeaderTitle badgeLabel="8">
                          원동기장치 자전거(전동킥보드, 전동이륜평행차, 전동기의 동력만으로 움직일 수 있는 자전거 등
                          개인형 이동장치를 포함)를 사용하십니까? (다만, 전동휠체어, 의료용 스쿠터 등 보행보조용
                          의자차는 제외합니다.)
                        </QuestionRadioCardHeaderTitle>
                        <RadioGroup
                          className={'gap-[1.2rem] w-[11rem]'}
                      ...
                      <QuestionRadioCardContents>
                        <Gcol className="w-full" placement="ss" variant="box-detail">
                          ...
                          <Typo icon="detail" variant="body-sm">
                            ...
                            <b>개인형이동장치*</b>를 포함한 <b>원동기장치 자전거*</b>를 사용하게 된 사실을 지체없이
                            회사에 알리지 않은 경우 계약해지 등 알릴 의무 위반에 따른 <b>불이익*</b>이 발생할 수
                            있습니다. <b>(*보험계약자가 직접 기재하여야 하는 문구)</b>
                          </Typo>
                        </Gcol>
                      </QuestionRadioCardContents>
                      ...
                      <QuestionRadioCardContents>
                        ...
                        <Grid className="w-full gap-[0.8rem] px-[1rem] flex items-center flex-row">
                          ...
                          >
                            ...
                            <Grow className="flex justify-start">
                              <CheckboxGroupItem value="d" disabled={_simpleMode}>
                                자격증명칭
                              </CheckboxGroupItem>
                              <Input
                    ...
                    >
                      <QuestionRadioCardHeader>
                        <QuestionRadioCardHeaderTitle badgeLabel="11">
                          향후 3개월 이내에 다음과 같은 해외위험지역으로 출국할 예정이 있습니까? [전쟁지역,
                          미개척지(열대, 한대), 등반산악지대]
                        </QuestionRadioCardHeaderTitle>
                        <RadioGroup
                          className={'gap-[1.2rem] w-[11rem]'}
                ...
                <LayoutScrollItem className="w-full h-full gap-1 flex flex-col sticky">
                  ...
                  >
                    <Gcol
                      className={
                        isCollapsed ? 'bg-[#F4F4F4] rounded-[0.6rem] p-1' : 'bg-[#F4F4F4] rounded-t-[0.6rem] p-1'
                      }
                    >
                      <Typo variant={'body-sm'} weight={'bold'}>
                        답변내용
