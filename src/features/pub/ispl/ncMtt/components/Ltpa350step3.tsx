...
import { QuestionRadioCard, QuestionRadioCardContents, QuestionRadioCardHeader, QuestionRadioCardHeaderTitle } from '@common/QuestionRadioCard';
...
export function Ltpa350Step3({ simpleMode: _simpleMode }: Ltpa350Step3Props) {
  ...
  const scrollToCard = (badgeNum: number) => {
    ...
    const targetTop = anchor.getBoundingClientRect().top - container.getBoundingClientRect().top + container.scrollTop - stickyHeight;
        ...
        <LayoutMain className="grid grid-rows-[1fr] h-full">
          <LayoutMainBody>
            <LayoutScrollWrap className="grid-cols-[1fr_auto] gap-3">
              <LayoutScrollItem
                className="w-full h-full grid-rows-[auto_1fr] scroll-smooth"
                data-layout="scroll-item"
              >
                  <TabPager
                    className='grid-rows-[auto_auto] h-auto sticky top-0 z-20 bg-[#fff]'
                  data={Tabs}
                  active={TabActive}
                ...
                <Gcol gap={2} className='mt-[1.2rem]'>
                          ...
                          <FormTable caption="FormTable 예시" className="border-t border-solid border-[#D8D8D8] pt-2.5 mt-[1rem]" cols={[ 'w-[5.4rem]', 'w-auto']} lineTop variant="none">
                            <FormRow>
                              <FormCell
                                ...
                                variant="default"
                              >
                                <CheckboxGroup color="primary" onValueChange={() => {}} size="lg" variant="default" className='grid grid-cols-5' disabled={_simpleMode}>
                    ...
                    >
                      <QuestionRadioCardHeader>
                        ...
                        현재 운전을 하고 있습니까? 운전하고 계신다면 다음 중 어느 것입니까? (해당하는 것에 <CheckIcon color='#FF5C2E'/>표 하세요.)
                        </QuestionRadioCardHeaderTitle>
                        <RadioGroup
                          className={'gap-[1.2rem] w-[11rem]'}
                          width="auto"
                          ...
                          <TableHeader>
                            <TableRow className=''>
                              ...
                              <TableHead className='w-[auto] min-w-[26rem] [&>div]:justify-center'>
                                <Checkbox disabled={_simpleMode}>승합차</Checkbox>
                              </TableHead>
                              <TableHead className='w-[auto] min-w-[26rem] [&>div]:justify-center' >
                                <Checkbox disabled={_simpleMode}>화물차</Checkbox>
                              </TableHead>
                              <TableHead className='w-[auto] min-w-[26rem] [&>div]:justify-center' >
                                <Checkbox disabled={_simpleMode}>이륜자동차</Checkbox>
                              </TableHead>
                            </TableRow>
                          </TableHeader>
                          <TableBody>
                            ...
                            <TableRow>
                              ...
                              <TableCell colSpan={3}>
                                <Grid className='grid-flow-col grid-cols-3'>
                                  <Checkbox disabled={_simpleMode}>건설기계</Checkbox>
                                  <Checkbox disabled={_simpleMode}>농기계</Checkbox>
                                  <Grow className='flex justify-start'>
                                    <Checkbox disabled={_simpleMode}>기타운전차종</Checkbox>
                                    <Input
                    ...
                    >
                      <QuestionRadioCardHeader>
                        ...
                        원동기장치 자전거(전동킥보드, 전동이륜평행차, 전동기의 동력만으로 움직일 수 있는 자전거 등 개인형 이동장치를 포함)를 사용하십니까? (다만, 전동휠체어, 의료용 스쿠터 등 보행보조용 의자차는 제외합니다.)
                        </QuestionRadioCardHeaderTitle>
                        <RadioGroup
                          className={'gap-[1.2rem] w-[11rem]'}
                          width="auto"
                      ...
                      <QuestionRadioCardContents>
                        <Gcol className="w-full" placement="ss" variant="box-detail">
                          ...
                          <Typo icon="detail" variant="body-sm">본 질문에 ‘아니오’로 기재하고 보험계약 체결 후 <b>이륜자동차*</b> 또는 전동킥보드 등 <b>개인형이동장치*</b>를 포함한 <b>원동기장치 자전거*</b>를 사용하게 된 사실을 지체없이 회사에 알리지 않은 경우 계약해지 등 알릴 의무 위반에 따른 <b>불이익*</b>이 발생할 수 있습니다. <b>(*보험계약자가 직접 기재하여야 하는 문구)</b></Typo>
                        </Gcol>
                      </QuestionRadioCardContents>
                    </QuestionRadioCard>
                    ...
                    >
                      <QuestionRadioCardHeader>
                        ...
                        최근 1년 이내에 다음과 같은 취미를 자주 반복적으로 하고 있거나 관련 자격증을 가지고 있습니까? (해당하는 것에 <CheckIcon color='#FF5C2E'/>표 하세요.)
                        </QuestionRadioCardHeaderTitle>
                        <RadioGroup
                          className={'gap-[1.2rem] w-[11rem]'}
                          width="auto"
                      ...
                      <QuestionRadioCardContents>
                        ...
                        <Grid className="w-full gap-[0.8rem] px-[1rem] flex items-center flex-row">
                          ...
                          <CheckboxGroup color="primary" onValueChange={() => {}} size="lg" variant="default" className='gap-3'>
                            <Grow className='flex justify-start '>
                              <CheckboxGroupItem value="c" disabled={!periodType}>횟수</CheckboxGroupItem>
                              <Input
                            ...
                            <Grow className='flex justify-start'>
                              <CheckboxGroupItem value="d" disabled={_simpleMode}>자격증명칭</CheckboxGroupItem>
                              <Input
                    ...
                    >
                      ...
                      <QuestionRadioCardContents>
                        <Grow gap={4} placement='sc' className='px-2.5'>
                          <Typo variant="body-lg" weight={'bold'}>“예”인 경우 업무명 </Typo>
                          <Input width={207} placeholder='업무명을 입력하세요' readOnly={_simpleMode}></Input>
                        </Grow>
                      </QuestionRadioCardContents>
                    </QuestionRadioCard>
                    ...
                    >
                      <QuestionRadioCardHeader>
                        ...
                        향후 3개월 이내에 다음과 같은 해외위험지역으로 출국할 예정이 있습니까? [전쟁지역, 미개척지(열대, 한대), 등반산악지대]
                        </QuestionRadioCardHeaderTitle>
                       <RadioGroup
                          className={'gap-[1.2rem] w-[11rem]'}
                          width="auto"
                      ...
                      <QuestionRadioCardContents>
                        <Grid className='w-full gap-3 px-2.5'>
                          <CheckboxGroup className='grid grid-cols-[1fr_1fr] gap-x-[1.2rem] gap-y-[0.8rem] [&_label]:flex [&_label]:items-center [&_label]:gap-1 w-full [&_label]:w-full'>
                            <CheckboxGroupItem value="a" disabled={_simpleMode}>
                              <Typo variant='body-md' className='w-[9rem]'>해외출국기간</Typo>
                              <Input
                            ...
                            <CheckboxGroupItem value="b" disabled={_simpleMode}>
                              <Typo variant='body-md' className='w-[5rem]'>지역</Typo>
                              <Input
                            ...
                            <CheckboxGroupItem value="c" disabled={_simpleMode}>
                              <Typo variant='body-md' className='w-[9rem]'>출국목적</Typo>
                              <Input
                      ...
                      <QuestionRadioCardContents>
                        <Grid className="w-full grid-cols-[1fr_1fr] px-2.5">
                          <Grow className='justify-start' gap={2}>
                            <Typo variant="body-lg" weight={'bold'}>음주횟수</Typo>
                            <Grow>
                          ...
                          <Grow className='justify-start' gap={2}>
                            <Typo variant="body-lg" weight={'bold'}>음주량</Typo>
                            <Grow>
                    ...
                    >
                      ...
                      <QuestionRadioCardContents>
                        <Grid className="w-full grid-cols-[1fr_1fr] px-2.5">
                          <Grow className='justify-start' gap={2}>
                            <Typo variant="body-lg" weight={'bold'}>흡연량</Typo>
                            <Grow>
                              <Typo variant="body-md">주</Typo>
                              <Input
                          ...
                          <Grow className='justify-start' gap={2}>
                            <Typo variant="body-lg" weight={'bold'}>흡연기간</Typo>
                            <Grow>
                              <Input
                      ...
                      <QuestionRadioCardContents>
                        <Grid className='w-full gap-3 px-2.5'>
                          <CheckboxGroup className='grid grid-cols-[1fr_1fr_1fr] gap-3 [&_label]:flex [&_label]:items-center [&_label]:gap-1 w-full [&_label]:w-full'>
                            <CheckboxGroupItem value="a" disabled={_simpleMode} >
                              <Typo variant='body-md' className='w-[4.2rem]'>회사수</Typo>
                              <Input
                            ...
                            <CheckboxGroupItem value="b" disabled={_simpleMode} >
                              <Typo variant='body-md' className='w-[2.8rem]'>건수</Typo>
                              <Input
                            ...
                            <CheckboxGroupItem value="c" disabled={_simpleMode} >
                              <Typo variant='body-md' className='w-[6rem]'>월보험료</Typo>
                              <Input
                    ...
                    >
                      ...
                      <QuestionRadioCardContents>
                        <Grid className="w-full grid-cols-[1fr_1fr] px-2.5">
                          <Grow className='justify-start' gap={2}>
                            <Typo variant="body-lg" weight={'bold'}>키</Typo>
                            <Grow>
                              <Input
                          ...
                          <Grow className='justify-start' gap={2}>
                            <Typo variant="body-lg" weight={'bold'}>몸무게</Typo>
                            <Grow>
                              <Input
              ...
              <LayoutScrollItem className="w-full h-full gap-1 flex flex-col sticky" >
                <Gcol className='top-0 z-20 w-[5.6rem] border-[0.1rem] border-solid border-[#1E2124] rounded-[0.6rem]' gap={2}>
                  <Gcol className={isCollapsed ? 'bg-[#F4F4F4] rounded-[0.6rem] p-1' : 'bg-[#F4F4F4] rounded-t-[0.6rem] p-1'}>
                    <Typo variant={'body-sm'} weight={'bold'}>답변내용</Typo>
                    <Button
                      color="gray"
                      variant="outlined"
                ...
                <Gcol className='sticky top-0 z-20 w-[5.6rem] border-[0.1rem] border-solid border-[#1E2124] rounded-[0.6rem] text-center' gap={2}>
                  <Gcol className='bg-[#F4F4F4] rounded-t-[0.6rem] py-1' gap={1}>
                    <Gcol gap={0}>
                      <Typo variant={'body-sm'} weight={'bold'}>
                        ...
                        지급정보<br></br>
                        <TooltipQ>
                          <Typo variant="body-md" weight={'bold'}>주의</Typo>
                          <BulletList position="col">
                            <BulletListItem
                              type="dotBig"
                              size='md'
                    ...
                    <Typo variant={'body-sm'} weight={'bold'}>입원/수술</Typo>
                  </Gcol>
                  <Gcol className='w-full mb-2' gap={1}>
                    <Grow gap={1}>
                      <Typo variant={'body-sm'}>5년내</Typo>
                      <Typo variant={'body-sm'} weight={'bold'} color={'gray'}>무</Typo>
                    </Grow>
                    <Grow gap={1}>
                    ...
                    <Grow gap={1}>
                      <Typo variant={'body-sm'} weight={'bold'}>2년내</Typo>
                      <Typo variant={'body-sm'} weight={'bold'} color={'danger'}>무</Typo>
                    </Grow>
