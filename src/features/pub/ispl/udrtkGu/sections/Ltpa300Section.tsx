...
export default function Ltpa300Section() {
  ...
  const columnDefs = React.useMemo<ColDef<Ltpa300DummyDataRow>[]>(
    () => [
      ...
      { headerName: '모집직원번호', field: 'field02', width: 100, cellClass: 'text-center' },
      ...
      { headerName: '사용인', field: 'field05', width: 100, cellClass: 'text-center' },
      {
        headerName: '증권번호',
        field: 'field06',
        width: 120,
      ...
      { headerName: '점검설계번호', field: 'field07', width: 90, cellClass: 'text-center' },
      { headerName: '점검', field: 'field08', width: 130, cellClass: 'text-center' },
      {
        headerName: '피보험자명',
        field: 'field09',
        width: 100,
      ...
      { headerName: '점검일자', field: 'field10', width: 100, cellClass: 'text-center' },
      { headerName: '결과순번', field: 'field11', width: 100, cellClass: 'text-center' },
      { headerName: '사전확인시사용여부', field: 'field12', width: 130, cellClass: 'text-center' },
      { headerName: '점검방법', field: 'field13', width: 100, cellClass: 'text-center' },
      { headerName: '한도초과건수', field: 'field14', flex: 1, cellClass: 'text-center' },
    ],
    []
  );
  const pageSize = 4;
