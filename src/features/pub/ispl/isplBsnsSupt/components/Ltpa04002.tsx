...
const Ltpa040DummyDataT2: Ltpa040DummyDataRowT2[] = [
  {
    id: 1,
    field01:
      '한화 시그니처 여성 건강보험4.0 한화 시그니처 여성 건강보험4.0 한화 시그니처 여성 건강보험4.0 한화 시그니처 여성 건강보험4.0',
    field02:
      '1종 납입면제 강화형, 기본형[할증운영상품] 1종 납입면제 강화형, 기본형[할증운영상품] 1종 납입면제 강화형, 기본형[할증운영상품]',
    field03: '',
    field04: '00',
  },
  {
...
const Ltpa040DummyDataT6: Ltpa040DummyDataRowT6[] = [
  {
    ...
    field04: '표준',
    field05:
      '사망/후유, 진단비, 입원/통원, 수술/치료, 골절/화상, 검사/지원 사망/후유, 진단비, 입원/통원, 수술/치료, 골절/화상, 검사/지원 사망/후유, 진단비, 입원/통원, 수술/치료, 골절/화상, 검사/지원',
    field06: '00',
    field07: '00',
  },
  {
