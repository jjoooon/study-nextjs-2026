                    ...
                    >
                      <FormRow>
                        <FormCell title={'보험시기'}>
                          ...
                          <Button
                            color={'secondary'}
                            onClick={() => handleChildContractFieldChange('insuranceStartDate', getTodayStr())}
                            only={'default'}
                            size={'lg'}
                            variant={'outlined'}
                          >
                              ...
                              <FormCell title="연령">
                                <Grow gap={3}>
                                  ...
                                  <DatePickerInput
                                    ...
                                    mode={'single'}
                                    width={'9rem'}
                                    onChange={(_, v) => setChildBirthDate(v ?? '')}
                                    required
                                  />
                                </Grow>
                              </FormCell>
                    ...
                    >
                      <FormRow>
                        <FormCell title={'보험시기'}>
                          ...
                          <Button
                            color={'secondary'}
                            onClick={() => handlePropertyContractFieldChange('insuranceStartDate', getTodayStr())}
                            only={'default'}
                            size={'lg'}
                            variant={'outlined'}
                          >
                              ...
                              <FormRow>
                                ...
                                <FormCell title="연령">
                                  <Grow gap={3}>
                                    ...
                                    <DatePickerInput
                                      value={propertyBirthDate}
                                      mode={'single'}
                                      width={'9rem'}
                                      onChange={(_, v) => setPropertyBirthDate(v ?? '')}
                                      required
                                    />
                                  </Grow>
                                </FormCell>
                              ...
                              <FormRow>
                                <FormCell title="실손보상구분">
                                  <NativeSelect
                                    ...
                                    onChange={(e) =>
                                      setPropertyActualLossTypeByTab((prev) => ({
                                        ...prev,
                                        [propertyTabValue]: e.target.value,
                                      }))
                                    }
                                  >
                                  ...
                                  <Checkbox
                                    ...
                                    onCheckedChange={(c) =>
                                      setPropertyHasFireExtinguisherByTab((prev) => ({
                                        ...prev,
                                        [propertyTabValue]: c === true,
                                      }))
                                    }
                                    size="md"
                                    variant="default"
                                ...
                                <FormCell title="기타상세">
                                  <Grow gap={3}>
                                    <Checkbox
                                      ...
                                      onCheckedChange={(c) =>
                                        setPropertyIsSpecialBuildingByTab((prev) => ({
                                          ...prev,
                                          [propertyTabValue]: c === true,
                                        }))
                                      }
                                    ...
                                    <Checkbox
                                      ...
                                      onCheckedChange={(c) =>
                                        setPropertyIsMultipleComplexBuildingByTab((prev) => ({
                                          ...prev,
                                          [propertyTabValue]: c === true,
                                        }))
                                      }
                    ...
                    >
                      <FormRow>
                        <FormCell title={'보험시기'}>
                          ...
                          <Button
                            color={'secondary'}
                            onClick={() => handleGroupContractFieldChange('insuranceStartDate', getTodayStr())}
                            only={'default'}
                            size={'lg'}
                            variant={'outlined'}
                          >
                              ...
                              <FormCell title="직업" colSpan={3}>
                                <Grow className="gap-1 flex-nowrap w-full" placement={'ss'}>
                                  <Input
                                    aria-label="직업코드"
                                    width={'7.6rem'}
                                    value={groupCurrentItem.jobCode}
                                    readOnly
                                  />
                                  <Input
                                    aria-label="직업분류"
                                  ...
                                  <Input
                                    aria-label="직업등급"
                                    width={'2xs'}
                                    value={groupCurrentItem.jobGrade}
                                    readOnly
                                  />
                                </Grow>
                              </FormCell>
                            ...
                            <FormRow>
                              <FormCell title="계약자와 관계">
                                <Input
                                  aria-label="계약자"
                                  width={'14rem'}
                                  value={groupCurrentItem.groupName}
                                  readOnly
                                />
                                는 계약자의
                                <NativeSelect
                      ...
                      <FormRow>
                        <FormCell title={'보험시기'}>
                          <DatePickerInput
                            ...
                            mode={'single'}
                            width={'9rem'}
                            onChange={(_, formattedValue) => setPensionInsuranceStartDate(formattedValue ?? '')}
                          />
                          <Button
                            color={'secondary'}
                            onClick={() => setPensionInsuranceStartDate(getTodayStr())}
                            only={'default'}
                            size={'lg'}
                            variant={'outlined'}
                          >
