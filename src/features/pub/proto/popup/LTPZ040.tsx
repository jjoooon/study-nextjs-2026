...
export const LTPZ040 = ({ open, onOpenChange }: PopupBaseProps) => {
  ...
  const DummyData: DummyDataType[] = [
    { id: 1, isCheck: false, field01: '정상', field02: 'LA231231231',  field03: '한화 세이프단체보', field04: '일상해의료비(가입자)', field05: '999,999,999', field06: '999,999,999', field07: 'CLA00172', field08: '2026-01-01', field09: '2026-01-01', field10: '정상', field11: '김한화', field12: '천안지점' },
    { id: 2, isCheck: false, field01: '정상', field02: 'LA231231231',  field03: '한화 세이프단체보', field04: '일상해의료비(가입자)', field05: '999,999,999', field06: '999,999,999', field07: 'CLA00172', field08: '2026-01-01', field09: '2026-01-01', field10: '정상', field11: '김한화', field12: '천안지점' },
    { id: 3, isCheck: false, field01: '정상', field02: 'LA231231232342',  field03: '한화 시스템', field04: '일상해의료비(가입자)', field05: '999,999,999', field06: '999,999,999', field07: 'CLA00172', field08: '2026-01-01', field09: '2026-01-01', field10: '정상', field11: '김한화1', field12: '천안지점1' },
  ];
                ...
                <Gcol className='w-full' gap={4}>
                  ...
                  <Gcol className='w-full' gap={4}>
                    ...
                    <Gcol className="w-full" placement="ss" variant="box-detail" >
                      ...
                      <Typo icon="detail" variant="body-sm" >
                        전환전 계약에 「특정 신체부위 질병 보장제한부 인수 특별약관」, 「특별조건부 특별약관」 등이 부가되어 있을 경우, 전환용 계약에 전환전 계약의 조건과 동일하게 부가하여 효력을 갖출 수 있습니다.
                      </Typo>
                      <Typo icon="detail" variant="body-sm" >
                        <b>전환전 계약의 해약일 또는 변경기준일자와 전환후 신계약 보험시기가 동일하여야 청약완료 가능합니다.</b>
                      </Typo>
                      <Typo icon="detail" variant="body-sm" >
