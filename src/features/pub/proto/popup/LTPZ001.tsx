      ...
      <DialogContent showCloseButton resizable={true} size="2xl" >
        ...
        <DialogSection className="grid-cols-[1fr_auto]">
          ...
          <Grid gap={2} placement={'ss'} className="w-[26.4rem] shrink-0 grid-rows-[auto_1fr] overflow-hidden">
            <Typo tag={'h3'} variant={'heading-lg'}>발행방법</Typo>
            <TabPager
              data={[
            ...
            >
              <Gcol className="h-full absolute px-2.5 py-3" placement={'ss'}>
                ...
                {tabActive === 'tab1' && (
                  <Gcol placement={'ss'} gap={4} className="w-full pb-[3.5rem]">
                    <Gcol placement={'ss'} gap={2} className="w-full">
                      <Typo tag={'h3'} variant={'heading-sm'}>인쇄타입</Typo>
                    ...
                    <Gcol placement={'ss'} gap={2} className="w-full">
                      <Typo tag={'h3'} variant={'heading-sm'}>일괄출력</Typo>
                    ...
                    <Gcol placement={'ss'} gap={2} className="w-full">
                      <Typo tag={'h3'} variant={'heading-sm'}>계약체결동의서 유형</Typo>
                      <CheckboxGroup className="gap-3">
                    ...
                    <Gcol placement={'ss'} gap={2} className="w-full">
                      <Typo tag={'h3'} variant={'heading-sm'}>마케팅 동의서 유형</Typo>
                      <RadioGroup className='gap-[1.2rem]'>
                    ...
                    <Gcol placement={'ss'} gap={2} className="w-full">
                      <Typo tag={'h3'} variant={'heading-sm'}>필수 스캔문서 출력일시</Typo>
                      <BulletList type={'dash'} size={'sm'}>
                        <BulletListItem>
                          상품설명서: 미출력 <Badge color={'red'} className="ml-1">출력필요</Badge>
                        </BulletListItem>
                        <BulletListItem>
                          청약서류: 미출력 <Badge color={'red'} className="ml-1">출력필요</Badge>
                        </BulletListItem>
                        <BulletListItem>
                          계약체결동의서: 출력 <Badge color={'red'} className="ml-1">출력필요</Badge>
                        </BulletListItem>
                        <BulletListItem>
                          고객확인서: 미출력 
                        </BulletListItem>
                ...
                {tabActive === 'tab3' && (
                  <Gcol placement={'ss'} gap={4} className="w-full pb-[3.5rem] ">
                    <Gcol placement={'ss'} gap={2} className="w-full">
                      <Typo tag={'h3'} variant={'heading-sm'}>팩스번호</Typo>
                      <Grow>
                        <NativeSelect
                          value={form.faxArea}
                          onChange={e => setFormField('faxArea', e.target.value)}
                        >
                ...
                {tabActive === 'tab4' && (
                  <Gcol placement={'ss'} gap={4} className="w-full pb-[3.5rem]">
                    <Gcol placement={'ss'} gap={2} className="w-full">
                      <Typo tag={'h3'} variant={'heading-sm'}>전송대상</Typo>
                      <RadioGroup className='gap-[0.6rem] flex flex-col items-start'>
                        ...
                        <RadioGroupItem value="접속자(현재 로그인 기준)전송">접속자(현재 로그인 기준)전송</RadioGroupItem>
                      </RadioGroup>
                    </Gcol>
                    ...
                    <Gcol placement={'ss'} gap={2} className="w-full">
                      <Typo tag={'h3'} variant={'heading-sm'}>수신자명</Typo>
                      <Grow>
                    ...
                    <Gcol placement={'ss'} gap={2} className="w-full">
                      <Typo tag={'h3'} variant={'heading-sm'}>휴대폰번호</Typo>
                      <Grow>
                        <NativeSelect
