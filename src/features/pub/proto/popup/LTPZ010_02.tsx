...
interface LTPZ010_02Props {
  open?: boolean;
  onOpenChange?: (open: boolean) => void;
}

export const LTPZ010_02 = ({ open, onOpenChange }: LTPZ010_02Props) => {
        ...
        <DialogSection className="grid-rows-[auto_1fr]">
          <Grow className='w-full' variant="box-round" placement={'ss'}>
            <FormTable caption="설계번호" variant='none' cols={[
              ...
              <FormRow>
                <FormCell title={'설계번호'}>
                  <Typo color="default" tag="span" variant="body-lg" weight="bold">LA123123123123-1</Typo>
                </FormCell>
                <FormCell title={'보험시기'}>
                  <Typo color="default" tag="span" variant="body-lg" weight="bold">2026-01-01</Typo>
                </FormCell>
              </FormRow>
              <FormRow>
                <FormCell title={'유효기한'}>
