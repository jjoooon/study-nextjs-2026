   ...
   type DummyDataType = {
    ...
    const columnDefs: (ColDef<DummyDataType> | ColGroupDef<DummyDataType>)[] = [
      ...
      },
      {
        ...
        width: 180,
        field: 'field02',
        cellClass: 'text-right pr-[1rem]! [&_.ag-cell-wrapper]:overflow-visible! [&_.ag-cell-value]:overflow-visible! [&_.ag-cell-value]:whitespace-nowrap [&_.ag-input-field-input]:pr-[1rem]! [&_.ag-input-field-input]:tracking-normal',
        autoHeight: true,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent showCloseButton resizable={true} size="xl" >
        <DialogHeader>
          <DialogTitle>
            <Typo tag={'strong'} variant={'heading-lg'}>통합/세트담보누적조정</Typo>
            ...
            <Grow className='w-full'>
              <div className="ag-theme-alpine">
                <AgGridReact<DummyDataType>
                  ...
                  getRowStyle={params => (params.node.rowIndex === 0 && !params.node.rowPinned ? { fontWeight: '700' } : undefined)}
                  defaultColDef={{ 
                    sortable: false,
                    resizable: false,
                    autoHeight: true,
