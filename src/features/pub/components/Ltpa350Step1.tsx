                              ...
                              <FormCell title="직업" colSpan={3}>
                                <Grow className="gap-1 flex-nowrap w-full" placement={'ss'}>
                                  <Input
                                    aria-label="직업코드"
                                    width={'7.6rem'}
                                    value={currentPerson.jobCode}
                                    readOnly
                                  />
                                  <Input
                                    aria-label="직업분류"
                                    width={'27.4rem'}
                                    value={currentPerson.jobName}
                                    readOnly
                                  />
                                  <Button
                                    aria-label="피보험자 검색"
                            ...
                            <FormRow>
                              <FormCell title="주피와 관계">
                                ...
                                <NativeSelect
                                  ...
                                  onChange={(e) =>
                                    updateInsuredField(tabValue, 'relationWithContractor', e.target.value)
                                  }
                                >
                              ...
                              <FormRow>
                                <FormCell title="실손보상구분">
                                  <NativeSelect
                                    ...
                                    onChange={(e) =>
                                      handlePropertyActualLossTypeChange(propertyTabValue, e.target.value)
                                    }
                                  >
                      ...
                      <FormRow>
                        <FormCell title={'보험시기'}>
                          <DatePickerInput
                            ...
                            width={'9rem'}
                            onChange={(_, formattedValue) =>
                              handlePensionInsuranceStartDateChange(formattedValue ?? '')
                            }
                          />
                          <Button
                            color={'secondary'}
