...
import { Ltpa350s4DummyData } from '../data/ltpa350s4Data';
import type { Ltpa350s4DummyDataRow } from '../data/ltpa350s4Data';

ModuleRegistry.registerModules([AllCommunityModule]);

export default function Ltpa350s4Section() {
  ...
  // AgGrid Column
  const columnDefs: (ColDef<Ltpa350s4DummyDataRow> | ColGroupDef<Ltpa350s4DummyDataRow>)[] = [
    {
      headerName: '설계번호',
      flex: 1,
      cellClass: 'text-center px-0!',
      cellRenderer: createFieldRenderer<Ltpa350s4DummyDataRow>('field01'),
      autoHeight: true,
    },
    {
      headerName: '상품명/구분',
      ...
      children: [
        {
          ...
          cellClass: 'text-center px-0!',
          autoHeight: true,
          cellRenderer: createFieldRenderer<Ltpa350s4DummyDataRow>('field02', (data?: Ltpa350s4DummyDataRow) => {
      ...
      children: [
        {
          ...
          cellClass: 'text-center px-0!',
          autoHeight: true,
          cellRenderer: createFieldRenderer<Ltpa350s4DummyDataRow>('field05', 'field06'),
        },
      ],
    },
      ...
      children: [
        {
          ...
          width: 100,
          autoHeight: true,
          cellRenderer: createFieldRenderer<Ltpa350s4DummyDataRow>('field07', 'field08'),
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          width: 90,
          autoHeight: true,
          cellRenderer: createFieldRenderer<Ltpa350s4DummyDataRow>(
      ...
      children: [
        {
          ...
          width: 90,
          autoHeight: true,
          cellRenderer: createFieldRenderer<Ltpa350s4DummyDataRow>('field09', 'field10'),
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          flex: 1,
          autoHeight: true,
          cellRenderer: createFieldRenderer<Ltpa350s4DummyDataRow>('field12', 'field13'),
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          flex: 1,
          autoHeight: true,
          cellRenderer: createFieldRenderer<Ltpa350s4DummyDataRow>('field14', (data?: Ltpa350s4DummyDataRow) => (
            <Grow gap={0.5}>
      ...
      children: [
        {
          ...
          width: 80,
          autoHeight: true,
          cellRenderer: createFieldRenderer<Ltpa350s4DummyDataRow>('field16', 'field17'),
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          flex: 1,
          autoHeight: true,
          cellRenderer: createFieldRenderer<Ltpa350s4DummyDataRow>('field18', (data?: Ltpa350s4DummyDataRow) => (
            <Button color="link" onClick={() => {}} only="default" size="lg" variant="text">
              {data?.field19}
            </Button>
          )),
  ...
  const columnDefs2: (ColDef<Ltpa350s4DummyDataRow> | ColGroupDef<Ltpa350s4DummyDataRow>)[] = [
  ...
  const columnDefs3: (ColDef<Ltpa350s4DummyDataRow> | ColGroupDef<Ltpa350s4DummyDataRow>)[] = [
  ...
  // rowSelection 사용시
  const [rowData, setRowData] = React.useState<Ltpa350s4DummyDataRow[]>(Ltpa350s4DummyData);
  const setErrorRows = React.useCallback<React.Dispatch<React.SetStateAction<number[]>>>(() => {}, []);
  const onCellValueChanged = React.useMemo(
    () => createCellValueChangedHandler<Ltpa350s4DummyDataRow, number>('isCheck', setRowData, setErrorRows, 'id'),
        ...
        mainBody={
          <Gcol placement="ss">
            ...
            <Gcol className="w-full">
              <div className="ag-theme-alpine ltpa350s4-grid">
                <AgGridReact<Ltpa350s4DummyDataRow>
